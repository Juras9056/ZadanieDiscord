/**
 * dm_voice.js — WebRTC private voice call for DM conversations.
 * Uses DMVoiceConsumer at ws/voice-dm/<username>/
...
(function () {
  ...
  function removeParticipant(username) {
    ...
    if (!participantsList.querySelector('.badge')) {
      ...
      em.id = 'emptyMsg';
      em.textContent = 'Nikt jeszcze nie dołączył';
  ...
  function closePeer(username) {
    ...
    const a = document.getElementById('audio-' + username);
    if (a) a.remove();
